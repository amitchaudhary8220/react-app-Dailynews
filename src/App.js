...
const App= ()=> {
  ...
  const apiKey = "703bc98a910344a2b978149071aefd59";
...
/>
        <Navbar/>
          ...
          <Routes>
            ...
            <Route exact path="/home" element={<News apiKey={apiKey} setProgress={setProgress} key='general' pageSize={6} country={'in'} category={'general'} />} />
